...
def init_db() -> None:
    ...
    from core.models import Paper, PaperAnalysis, Experiment, ExperimentResult, ResearchReport, Contradiction, ResearchGap, ThemeCluster, TokenUsageLog, EvalMetric, BenchmarkItem, BenchmarkRun, BenchmarkItemResult, Lesson  # noqa: F401
    engine = get_engine()
